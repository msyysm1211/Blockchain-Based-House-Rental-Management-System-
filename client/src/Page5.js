...
class App extends Component {
    ...
    render() {
        return (
            <div>
                {/*<Button onClick={this.test2}>1234</Button>*/}
                <div>
                    <SimpleTable  ContractList={this.props.ContractList} contract={this.props.target} accounts={this.props.target3} ContractInfoList={this.props.ContractInfoList} IndexList={this.props.IndexList}
                    enumList={this.props.enumList}/>
                </div>
            </div>
        )
    }
