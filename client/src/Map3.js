...
class Amap extends React.Component {
   ...
   test=()=>{
       var startDate=document.getElementById('searchText')
        ...
        return (
            <>
                <div style={{ width: '100%', height: '300px', position: 'relative' }}>
                    ...
                    <Map  plugins={['ToolBar']} events={this.amapEvents} amapkey={'b8d202b729de70a3782c420e5ab07d61'}style={{marginTop:20}} center={this.state.markerPosition}>
